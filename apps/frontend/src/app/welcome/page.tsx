 ...
 *
 * Wir validieren die session_id nicht clientseitig — Stripe ist die
 * canonical Source, Webhook ist async. Falls der User schneller
 * klickt als der Webhook ankommt, sieht er kurz Trial-Banner mit
 * "Subscription wird eingerichtet" — kein Problem.
 */
