  ...
  return (
    <section className="rounded-lg border border-slate-200 bg-white">
      ...
      <div className="px-4 py-3">
        ...
        <div className="border border-slate-100 rounded p-3 mb-3 bg-slate-50">
          ...
          <div className="flex items-center gap-2">
            <code className="flex-1 text-xs bg-white border border-slate-200 rounded px-2 py-1 truncate">
              {buildShareUrl()}
            </code>
            <button
            ...
            {accesses.map((a) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    <code className="flex-1 text-xs bg-slate-50 border border-slate-200 rounded px-2 py-1 truncate">
                      {url}
                    </code>
                    <button
      ...
      >
        ...
        <div className="space-y-1">
          <label htmlFor="email" className="text-sm font-medium">
            E-Mail <span className="text-slate-400">(optional, für Notifications)</span>
          </label>
          <input
            id="email"
            type="email"
