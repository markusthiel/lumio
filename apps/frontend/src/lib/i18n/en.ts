...
export const en = {
  ...
  apiError: {
    ...
    invalidTaxCode: "The tax code is not valid. Please check it.",
    invalidVatNumber: "The VAT number is not valid. Please check it.",
    invoiceDetailsRequired: "Please fill in all invoice details.",
    invalidEAddress: "The e-invoice address is not valid. Please check it.",
    invalidPhone: "The phone number looks too short. Please check it.",
    phoneRequired: "A phone number is required for delivery.",
    taxCodeRequired: "A tax code is required.",
    validationFailed: "Some details are missing or invalid. Please check the form and try again.",
  ...
  printShop: {
    ...
    region: "Province / region (optional)",
    shipToResidence: "Ship to my residence address",
    invoiceSection: "Invoice",
    invoiceRequest: "I need an invoice",
    invoiceSameAsCustomer: "Use my details above (name, tax code, address)",
    invoiceName: "Company name",
    vatNumber: "VAT number",
    invoiceTaxCode: "Tax code",
    invoiceAddress: "Invoice address",
    optional: "optional",
    invoiceKindLegend: "The invoice is for",
    invoiceKindPrivate: "A private individual",
    invoiceKindBusiness: "A company or professional",
    invoiceNamePrivate: "Full name",
    email: "Email",
    street: "Street + no.",
    ...
    eAddress: "E-invoice address",
    eAddressInvalid: "Enter a 7-character recipient code or a PEC address.",
    eAddressHint: "Leave it empty if you have neither a recipient code nor a PEC: the invoice is then made available in your tax authority account (code 0000000).",
    note: "Note (optional)",
  ...
  printSettings: {
    ...
    currency: "Currency",
    invoicingTitle: "Tax ID & invoice details",
    invoicingDesc: "Choose what the checkout asks for beyond name, address and phone. You know what your country and your invoicing tool need — everything is off until you turn it on.",
    checkoutTaxId: "Tax ID at checkout",
    checkoutTaxIdHint: "Asked of every customer, whether or not they want an invoice (in Italy: the codice fiscale). It uses the Tax ID field below for its label and its check.",
    fieldVatNumber: "VAT number",
    fieldTaxId: "Tax ID",
    fieldEAddress: "E-invoice address",
    forPrivate: "Private customers",
    forBusiness: "Businesses",
    modeOff: "Not asked",
    modeOptional: "Optional",
    modeRequired: "Required",
    fieldLabel: "Label shown to the customer",
    labelDefault: "Default label",
    checkAs: "Check as",
    checkGeneric: "Anything plausible (letters and digits)",
    vatCheckHint: "Checked by the country prefix the customer types (DE…, FR…, IT…); without a prefix, by the country of the invoice address.",
    checkHint: "A check looks at the format and the check digit, nothing more — no number is looked up anywhere. A typed check only applies to customers living in that country; for everyone else anything plausible is accepted, and a required field becomes optional.",
  ...
  orderDetail: {
    ...
    secInvoice: "Invoice requested",
    invoiceToLabel: "Invoice to",
    vatNumberLabel: "VAT number",
    eAddressLabel: "E-invoice address",
    invoiceKindLabel: "Invoice for",
    kindPrivate: "Private individual",
    kindBusiness: "Company or professional",
