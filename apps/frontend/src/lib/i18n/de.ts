...
export const de: LocaleDict = {
  ...
  apiError: {
    ...
    invalidTaxCode: "Die Steuernummer ist ungültig. Bitte prüfen.",
    invalidVatNumber: "Die USt-IdNr. ist ungültig. Bitte prüfen.",
    invoiceDetailsRequired: "Bitte alle Rechnungsdaten ausfüllen.",
    invalidEAddress: "Die Adresse für die E-Rechnung ist ungültig. Bitte prüfen.",
    invalidPhone: "Die Telefonnummer ist zu kurz. Bitte prüfen.",
    phoneRequired: "Für die Lieferung wird eine Telefonnummer benötigt.",
    taxCodeRequired: "Eine Steuernummer ist erforderlich.",
    validationFailed: "Einige Angaben fehlen oder sind ungültig. Bitte Formular prüfen und erneut versuchen.",
  ...
  printShop: {
    ...
    customerData: "Ihre Daten",
    firstName: "Vorname",
    lastName: "Nachname",
    taxCode: "Steuernummer",
    residenceAddress: "Wohnadresse",
    region: "Provinz / Region (optional)",
    shipToResidence: "An meine Wohnadresse liefern",
    invoiceSection: "Rechnung",
    invoiceRequest: "Ich benötige eine Rechnung",
    invoiceSameAsCustomer: "Meine Angaben von oben verwenden (Name, Steuernummer, Adresse)",
    invoiceName: "Firmenname",
    vatNumber: "USt-IdNr.",
    invoiceTaxCode: "Steuernummer",
    invoiceAddress: "Rechnungsadresse",
    optional: "optional",
    invoiceKindLegend: "Die Rechnung lautet auf",
    invoiceKindPrivate: "Eine Privatperson",
    invoiceKindBusiness: "Ein Unternehmen oder Freiberufler",
    invoiceNamePrivate: "Vor- und Nachname",
    email: "E-Mail",
    ...
    eAddress: "Adresse für die E-Rechnung",
    eAddressInvalid: "Bitte einen 7-stelligen Empfängercode oder eine PEC-Adresse eingeben.",
    eAddressHint: "Wenn Sie weder Empfängercode noch PEC haben, lassen Sie das Feld leer: Die Rechnung wird dann in Ihrem Bereich bei der Steuerbehörde bereitgestellt (Code 0000000).",
  ...
  printSettings: {
    ...
    currency: "Währung",
    invoicingTitle: "Steuer- und Rechnungsdaten",
    invoicingDesc: "Legen Sie fest, was der Checkout über Name, Adresse und Telefon hinaus abfragt. Sie wissen, was Ihr Land und Ihre Rechnungssoftware brauchen — alles ist aus, bis Sie es einschalten.",
    checkoutTaxId: "Steuer-ID beim Bestellen",
    checkoutTaxIdHint: "Wird von jedem Kunden verlangt, auch ohne Rechnungswunsch (in Italien: der Codice fiscale). Bezeichnung und Prüfung stammen aus dem Feld Steuer-ID unten.",
    fieldVatNumber: "USt-IdNr.",
    fieldTaxId: "Steuer-ID",
    fieldEAddress: "Adresse für E-Rechnung",
    forPrivate: "Privatkunden",
    forBusiness: "Unternehmen",
    modeOff: "Nicht abgefragt",
    modeOptional: "Optional",
    modeRequired: "Pflicht",
    fieldLabel: "Bezeichnung für den Kunden",
    labelDefault: "Standardbezeichnung",
    checkAs: "Prüfen als",
    checkGeneric: "Alles Plausible (Buchstaben und Ziffern)",
    vatCheckHint: "Geprüft anhand des Länderpräfixes, den der Kunde eingibt (DE…, FR…, IT…); ohne Präfix anhand des Landes der Rechnungsadresse.",
    checkHint: "Die Prüfung betrachtet Format und Prüfziffer, mehr nicht — nirgendwo wird eine Nummer nachgeschlagen. Eine typisierte Prüfung gilt nur für Kunden aus diesem Land; für alle anderen genügt ein plausibler Wert, und ein Pflichtfeld wird optional.",
  ...
  orderDetail: {
    ...
    phoneLabel: "Telefon",
    residenceLabel: "Wohnadresse",
    secInvoice: "Rechnung gewünscht",
    invoiceToLabel: "Rechnung an",
    vatNumberLabel: "USt-IdNr.",
    eAddressLabel: "Adresse für E-Rechnung",
    invoiceKindLabel: "Rechnung für",
    kindPrivate: "Privatperson",
    kindBusiness: "Unternehmen oder Freiberufler",
