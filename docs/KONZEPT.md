...
**Projektname:** Lumio
**Typ:** Open-Source, selbst-gehostete Plattform zum Teilen, Proofing und Ausliefern von Foto- und Video-Shootings
**Lizenz:** AGPL-3.0
...
- **Lizenz**: AGPL-3.0 schützt davor, dass jemand das als SaaS hostet, ohne Änderungen zurückzugeben. MIT macht's einfacher für die Community. Mein Vorschlag: **AGPL-3.0** mit "Hosted Plan"-Möglichkeit für dich selbst (Dual License denkbar).
